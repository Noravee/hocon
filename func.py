...
parameters = {"type": "object", "properties": {0: {"name": "", "type": [], "description": ""}}, "required": []}

# Initialize session state variables
if "functions" not in st.session_state:
    st.session_state.functions = {0: {"description": "", "parameters": parameters, "module": "", "class": ""}}
...
error_free = True  # Track overall validity
...
for key in input_keys:
    ...
    with cols[0]:
        ...
        st.session_state.functions[key]["description"] = st.text_area(
            "Function description",
            value=st.session_state.functions[key]["description"],
            key=f"description_{key}",
            help="Description of function",
        )
    ...
    for param_key in param_keys:
        ...
        with param_cols[0]:
            ...
            with st.expander(f"Parameter: {param_name if param_name else ''}"):
                ...
                st.session_state.functions[key]["parameters"]["properties"][param_key]["description"] = st.text_area(
